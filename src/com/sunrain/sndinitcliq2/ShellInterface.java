...
public class ShellInterface {
	...
	public static void turn_on_red_led(boolean state) {
		if (state) {
			ShellInterface
					.runCommand("echo \"0\" > /sys/class/leds/red/brightness");
			ShellInterface
					.runCommand("echo \"1000\" > /sys/class/leds/red/brightness");
		} else
			ShellInterface
					.runCommand("echo \"0\" > /sys/class/leds/red/brightness");
	}
	...
	public static void turn_on_blue_led(boolean state) {
		if (state) {
			ShellInterface
					.runCommand("echo \"0\" > /sys/class/leds/blue/brightness");
			ShellInterface
					.runCommand("echo \"1000\" > /sys/class/leds/blue/brightness");
		} else
			ShellInterface
					.runCommand("echo \"0\" > /sys/class/leds/blue/brightness");
	}
	...
	public static void turn_on_green_led(boolean state) {
		if (state) {
			ShellInterface
					.runCommand("echo \"0\" > /sys/class/leds/green/brightness");
			ShellInterface
					.runCommand("echo \"1000\" > /sys/class/leds/green/brightness");
		} else
			ShellInterface
					.runCommand("echo \"0\" > /sys/class/leds/green/brightness");
	}
