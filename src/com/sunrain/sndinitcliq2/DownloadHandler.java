...
/**
 * Created by IntelliJ IDEA. User: pedro Date: 6/1/11 Time: 6:58 PM To change
...
public class DownloadHandler {
	...
	public Boolean getFileFromURL(String fileURL, String targetFielPath) {
		try {
			...
			URL url = new URL(fileURL);// new URL(Constants.ROM_SERVER_URL+
										// fileURL);
			File file = new File(targetFielPath);
	...
	public static String getStringFromURL(String stringURL) {
		try {
